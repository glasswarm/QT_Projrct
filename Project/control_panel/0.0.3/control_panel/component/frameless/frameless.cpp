...
void frameless::initWindow()
{
     ...
     main_pointer->ui->Title->setFont(QFont("微软雅黑",11));
     ...
     main_pointer->ui->Title_Icon->setStyleSheet("border-image:url(:/app/images/Resources/Icon/app.png)");
     main_pointer->setWindowIcon(QIcon(":/app/images/Resources/Icon/under.png"));
}
...
//     main_pointer->ui->title_Widget->setMinimumHeight(40);
     ...
     main_pointer->ui->Title_Icon  ->setMinimumHeight(16);
     ...
     main_pointer->ui->Title_Icon  ->setMaximumHeight(16);

     main_pointer->ui->title_Widget->move(0,0);
     main_pointer->ui->Title_Icon->setFixedHeight(18);
     main_pointer->ui->Title_Icon->setFixedWidth (18);
     ...
     main_pointer->ui->Title_Icon ->setMaximumWidth(16);
     ...
     main_pointer->ui->Title_Icon ->setMinimumWidth(16);
