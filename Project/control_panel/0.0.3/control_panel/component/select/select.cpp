...
void select::contents_init()
{
     main_pointer->ui->contents->setIcon(QIcon(QPixmap(":/select/images/Resources/Icon/select/contents.png")) );
     main_pointer->ui->contents->setIconSize(QSize(26,26));

     main_pointer->ui->add_components->setIcon(QIcon(QPixmap(":/select/images/Resources/Icon/select/add.png")) );
     main_pointer->ui->add_components->setIconSize(QSize(30,30));
...
void select::Css_init()
{
...

     {
         ...
         main_pointer->ui->contents->setStyleSheet(qssStyle);
         qssFile.close();
     }


     main_pointer->ui->wifi_btn->setIcon(QIcon(QPixmap(":/select/images/Resources/Icon/select/wifi.png")));
     main_pointer->ui->wifi_btn->setIconSize(QSize(38,27));
     main_pointer->ui->serial_btn->setIcon(QIcon(QPixmap(":/select/images/Resources/Icon/select/serial.png")));
     main_pointer->ui->serial_btn->setIconSize(QSize(50,27));

     select_wifi_btn         ->setText(" Wifi        ");
     select_serial_btn       ->setText(" Serial      ");
     select_pushButton_3_btn ->setText(" 按钮         ");
     select_pushButton_4_btn ->setText(" 按钮         ");
     select_pushButton_5_btn ->setText(" 按钮         ");

     select_wifi_btn         ->setFont(QFont("微软雅黑",select_font_size));
     select_serial_btn       ->setFont(QFont("微软雅黑",select_font_size));
     select_pushButton_3_btn ->setFont(QFont("微软雅黑",select_font_size));
     select_pushButton_4_btn ->setFont(QFont("微软雅黑",select_font_size));
     select_pushButton_5_btn ->setFont(QFont("微软雅黑",select_font_size));

     main_pointer->ui->add_components->setFont(QFont("黑体",select_font_size));
}

void select::Size_init()
{

     main_pointer->ui->select->setMaximumWidth(250);
     select_wifi_btn         ->setMaximumHeight(67);
     select_serial_btn       ->setMaximumHeight(67);
     select_pushButton_3_btn ->setMaximumHeight(67);
     select_pushButton_4_btn ->setMaximumHeight(67);
     select_pushButton_5_btn ->setMaximumHeight(67);
     main_pointer->ui->add_components->setMaximumHeight(50);
     main_pointer->ui->add_components->setMaximumWidth(180);

     main_pointer->ui->select->setMinimumWidth(250);
     select_wifi_btn         ->setMinimumHeight(67);
     select_serial_btn       ->setMinimumHeight(67);
     select_pushButton_3_btn ->setMinimumHeight(67);
     select_pushButton_4_btn ->setMinimumHeight(67);
     select_pushButton_5_btn ->setMinimumHeight(67);

     main_pointer->ui->add_components->setMinimumHeight(50);
     main_pointer->ui->add_components->setMinimumWidth(180);
}
